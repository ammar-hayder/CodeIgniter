...
$(document).ready(function(){
	...
	$("#select_address_pickup").click(function(){
		...
		if($('input[name=search_from]:checked').val()=='0' && $("#search_house_no").val()==""){
		...
		{
			if($('input[name=search_from]:checked').val()=='1'){
			...
			if(full_address!="") {
				...
				pickup_type = $('input[name=search_from]:checked').val();
	...
	$("#select_address_destination").click(function(){
		...
		else
		{
			...
			if(full_address!="") {
				...
				post_code = address_array[2];
				house_no = $("#search_house_no").val();
				destination_type = $('input[name=search_from]:checked').val();
				
				$("#thetable tbody").append(
					'<tr class="MoveableRow">' +
					  '<td style="width:80px;">' + house_no + '</td>' +
